...
struct BST {
		...
		// bool BST::CloneSubtree
		BTNode* findNode(BTNode*, type);
		void cloneSubtree2(BTNode*, BST*);
		...
		bool deepestNodes();
		void coutDeepestNodes(BTNode* node, int lvl, int heightOfTree);
		int heightOfTree(BTNode* root);
		//end

		//bool BST::display(int order, int source)
		bool display(int order, int source);
		void displayAscending(BTNode* currentNode, ostream& output);
		void displayDescending(BTNode* currentNode, ostream& output);
		//end
